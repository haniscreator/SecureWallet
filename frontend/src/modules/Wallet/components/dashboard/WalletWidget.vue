    ...
    <div class="flex-grow-1 d-flex flex-column">
        ...
        <div class="pa-4 pb-3 d-flex align-center">
             <template v-if="loading">
                <v-skeleton-loader type="avatar" size="36" class="mr-3"></v-skeleton-loader>
        ...
        <!-- Body -->
        <div class="pa-4 pt-3 flex-grow-1 d-flex flex-column justify-center" style="background-color: #F6F6F9;"> 
             <template v-if="loading">
                 <div class="mb-2">
                     <v-skeleton-loader type="heading" width="150" color="transparent"></v-skeleton-loader>
                 </div>
                 <div class="mt-auto pt-2">
                     <v-skeleton-loader type="text" width="100" color="transparent"></v-skeleton-loader>
                 </div>
             </template>
             <template v-else>
                 <div class="d-flex align-baseline mb-2">
                     <span class="text-h5 font-weight-bold mr-1">{{ symbol }}{{ amount }}</span>
...
/* Override skeleton loader default margins/padding if needed for perfect alignment, 
   but defaults are usually okay for this layout */
</style>
